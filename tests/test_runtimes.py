...
def test_from_info() -> None:
    ...
    runtime = runtimes[0]
    assert runtime.availability == fake_runtime["availability"] or runtime.availability is None
...
def test_list_installed_runtimes(all_runtimes: list[isim.Runtime]) -> None:
...
def test_from_identifier(all_runtimes: list[isim.Runtime]) -> None:
...
def test_from_name(all_runtimes: list[isim.Runtime]) -> None:
...
def test_equality(all_runtimes: list[isim.Runtime]) -> None:
...
def test_string_representations(all_runtimes: list[isim.Runtime]) -> None:
...
def test_runtime_attributes(all_runtimes: list[isim.Runtime]) -> None:
